  ...
  while (n_left_from > 0)
      ...
      while (n_left_from >= 4 && n_left_to_next >= 2)
	{
	  ...
	  b1 = vlib_get_buffer (vm, bi1);
          ...
          if(sw_if_index0 > 0  && sw_if_index0 < SNAT_INTERFACE_MAX_NUM)
          {
          		sm = &snat_per_interface[sw_if_index0];
          }
	  ...
	  vnet_feature_next (sw_if_index0, &next0, b0);
        ...
        trace0:
          ...
          if(sw_if_index1 > 0  && sw_if_index1 < SNAT_INTERFACE_MAX_NUM)
          {
          		sm = &snat_per_interface[sw_if_index1];
          }
